# Generated by Django 3.0.5 on 2020-06-22 10:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TlPrefecture',
            fields=[
                ('int_prefecture_id', models.AutoField(primary_key=True, serialize=False)),
                ('str_prefecture', models.CharField(max_length=10)),
                ('str_prefecture_kana', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='TlYubin',
            fields=[
                ('int_yubin_id', models.AutoField(primary_key=True, serialize=False)),
                ('int_public_code', models.IntegerField()),
                ('str_old_number', models.CharField(blank=True, max_length=7, null=True)),
                ('str_yubin_num', models.CharField(blank=True, max_length=10, null=True)),
                ('str_prefecture_kana', models.CharField(blank=True, max_length=255, null=True)),
                ('str_city_kana', models.CharField(blank=True, max_length=255, null=True)),
                ('str_town_kana', models.CharField(blank=True, max_length=255, null=True)),
                ('str_prefecture', models.CharField(blank=True, max_length=255, null=True)),
                ('str_city', models.CharField(blank=True, max_length=255, null=True)),
                ('str_town', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'tl_yubin',
                'managed': False,
        ...
        migrations.CreateModel(
            name='TPremise',
            fields=[
                ('int_premise_id', models.AutoField(primary_key=True, serialize=False)),
                ('int_user_branch_id', models.IntegerField()),
                ('int_user_section_id', models.IntegerField()),
                ('str_premise_code', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('str_name', models.CharField(max_length=100)),
                ('str_name_post', models.CharField(blank=True, max_length=100, null=True)),
                ('str_zip_code_3', models.CharField(blank=True, max_length=3, null=True)),
                ('str_zip_code_4', models.CharField(blank=True, max_length=4, null=True)),
                ('str_addr_state', models.CharField(max_length=20)),
                ('str_addr_city', models.CharField(max_length=50)),
                ('str_addr_block', models.CharField(blank=True, max_length=100, null=True)),
                ('str_addr_no', models.CharField(blank=True, max_length=100, null=True)),
                ('str_addr_block_open', models.CharField(blank=True, max_length=100, null=True)),
                ('str_addr_no_open', models.CharField(blank=True, max_length=100, null=True)),
                ('int_area_id', models.IntegerField(blank=True, null=True)),
                ('str_house_number', models.CharField(blank=True, max_length=255, null=True)),
                ('str_traffic', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('str_bus_stop_name_1', models.CharField(blank=True, max_length=60, null=True)),
                ...
                ('str_bus_stop_name_2', models.CharField(blank=True, max_length=60, null=True)),
                ...
                ('str_bus_stop_name_3', models.CharField(blank=True, max_length=60, null=True)),
                ...
                ('bol_del_flg', models.BooleanField(blank=True, null=True)),
                ('str_design', models.CharField(blank=True, max_length=50, null=True)),
                ('str_construction', models.CharField(blank=True, max_length=50, null=True)),
                ('str_external_finish', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('str_premise_short_name', models.CharField(blank=True, max_length=20, null=True)),
                ('str_adv_point', models.TextField(blank=True, null=True)),
                ('bol_management_rule_flg', models.BooleanField(blank=True, null=True)),
                ('str_structure_info', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('flt_longitude', models.FloatField(blank=True, null=True)),
                ('flt_latitude', models.FloatField(blank=True, null=True)),
                ('str_portal_state', models.CharField(blank=True, max_length=20, null=True)),
                ('str_portal_city', models.CharField(blank=True, max_length=100, null=True)),
                ('str_portal_add1', models.CharField(blank=True, max_length=20, null=True)),
                ('str_portal_add2', models.CharField(blank=True, max_length=20, null=True)),
                ('str_portal_add3', models.CharField(blank=True, max_length=20, null=True)),
                ('str_bus_line_name_1', models.CharField(blank=True, max_length=15, null=True)),
                ('str_bus_line_name_2', models.CharField(blank=True, max_length=15, null=True)),
                ('str_bus_line_name_3', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('str_portal_add4', models.CharField(blank=True, max_length=100, null=True)),
                ('int_public_code', models.CharField(blank=True, max_length=5, null=True)),
        ...
        migrations.CreateModel(
            name='TUnit',
            fields=[
                ('int_unit_id', models.AutoField(primary_key=True, serialize=False)),
                ('int_premise_id', models.IntegerField()),
                ('int_branch_id', models.IntegerField()),
                ('int_section_id', models.IntegerField()),
                ('str_unit_code', models.CharField(blank=True, max_length=100, null=True)),
                ('int_usage_id', models.IntegerField()),
                ('str_usage_type', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('str_com_comment', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('str_guarantee_detail', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('str_user_tel', models.CharField(max_length=20, null=True)),
                ('str_user_fax', models.CharField(max_length=20, null=True)),
                ('str_user_contact', models.CharField(max_length=20, null=True)),
                ('str_user_inquiry_detail', models.TextField(null=True)),
                ('int_user_media', models.IntegerField()),
                ('dat_created_at', models.DateTimeField(verbose_name='date created')),
                ('dat_updated_at', models.DateTimeField(verbose_name='date updated')),
                ('int_unit', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='tracking.TUnit')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tim_reception', models.DateTimeField(null=True, verbose_name='time reception')),
                ('tim_send_mail', models.DateTimeField(null=True, verbose_name='time auto mail send')),
                ...
                ('dat_created_at', models.DateTimeField(verbose_name='date created')),
                ('dat_updated_at', models.DateTimeField(verbose_name='date updated')),
                ('int_information_premise', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tracking.TPremise')),
                ('int_media', models.ForeignKey(default=99, on_delete=django.db.models.deletion.SET_DEFAULT, to='tracking.Media')),
            ],
        ),
        migrations.CreateModel(
            name='Authority',
            fields=[
                ...
                ('int_user', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='tracking.TUser')),
            ],
        ),
    ]
