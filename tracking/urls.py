...
urlpatterns = [
    ...
    path('unassigned_detail/<int:potential_customer_id>', views.unassigned_detail, name='unassigned_detail'),
    path('unassigned_tour/', views.unassigned_tour, name='unassigned_tour'),
    path('unassigned_detail_tour/<int:potential_customer_id>', views.unassigned_detail_tour, name='unassigned_detail_tour'),
    ...
    path('customer_detail_tour/<int:potential_customer_id>', views.customer_detail_tour, name='customer_detail_tour'),
]
